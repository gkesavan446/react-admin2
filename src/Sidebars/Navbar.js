...
function Navbar() {
    ...
    return (
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <div>
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Kesavan</span>
                <img class="img-profile rounded-circle" style={{ width: 30 }}
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0lKsIXKThA8hwLtrPrhF5NovSZOXrhb6HVmXxwHpx4_mjXz4fde7gper78G3ZT_b7z1E&usqp=CAU" />
            </div>
            <button
